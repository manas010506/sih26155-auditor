...
const InputField = ({ type = 'text', label, value, onChange, error, placeholder }) => (
    ...
    <div className="bg-grid" style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
      <div className="bezel-panel corner-marks" style={{ width: '100%', maxWidth: '400px', padding: '32px' }}>
        ...
        <div style={{ marginTop: '24px', display: 'flex', justifyContent: 'space-between', fontSize: '12px' }}>
          <Link to="/signup" style={{ color: 'var(--ink-dim)' }}>Create an account</Link>
          <Link to="/forgot-password" style={{ color: 'var(--ink-dim)' }}>Forgot password?</Link>
        </div>
      </div>
